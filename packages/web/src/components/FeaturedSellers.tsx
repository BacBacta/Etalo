      ...
      {sellers.map((seller) => {
        ...
        return (
          <Link
            key={seller.handle}
            href={`/${seller.handle}`}
            className="block min-h-[44px] overflow-hidden rounded-lg border border-neutral-200 bg-white transition-colors hover:border-neutral-400"
          >
            <div className="relative aspect-square bg-neutral-100">
              {seller.primary_image_url ? (
                ...
                <div className="flex h-full w-full items-center justify-center text-base text-neutral-400">
