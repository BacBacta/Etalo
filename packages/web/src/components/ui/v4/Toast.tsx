...
/**
 * V4 Toast notifications (J9 Block 3 Chunk 3h, dark variants J10-V5
 * Block 4e).
 *
 * Wraps the `sonner` Toaster with V4 styling via `toastOptions.classNames`
 * + lucide icons coloured against the Celo palette. Dark variants land
 * on the `dark:` Tailwind layer; sonner renders into a body portal but
 * `<html>` carries the `.dark` class so ancestor-selector variants still
 * activate inside the portal.
 *
...
export const ToasterV4 = ({ className, ...props }: ToasterProps) => (
  <Sonner
    ...
    toastOptions={{
      classNames: {
        toast: cn(
          "bg-celo-light text-celo-dark dark:bg-celo-dark-elevated dark:text-celo-light",
          "border border-celo-dark/[8%] dark:border-celo-light/[8%]",
        ...
        actionButton: cn(
          "bg-celo-forest text-celo-light dark:bg-celo-green dark:text-celo-dark dark:hover:bg-celo-green-hover",
